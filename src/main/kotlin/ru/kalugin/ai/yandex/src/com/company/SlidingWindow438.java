...
public class SlidingWindow438 {


    public static void main(String[] args) throws IOException {
        System.out.println(getArray("llllll", "te"));
    }
    ...
    public static List<Integer> getArray(String s, String p) {
        ...
        while (right < n) {
            ...
            if (right - left == m) {
                ...
                if (hash[c] >= 0)
                    count++; // anagram candidate can be == 0 when evenly used; but can also be  > 0 when there are extra
                hash[c]++;
            }
        }
        return rst;
